...
function getLanguageTransform(inputLanguage, outputLanguage){
  ...
  try {
    ...
    console.log(`Can read ${c.green(languageDefinitionPath)}`)
  } catch (err) {
    console.error(c.red('no access!'))
  }

  if(languageDefinitionAccess){
    console.log(c.green('languageDefinitionAccess'))
    console.log(c.green(languageDefinitionAccess))
...
function convert(args){
  ...
  transform = transform ? transform : getLanguageTransform(args.inputLanguage, args.outputLanguage)
